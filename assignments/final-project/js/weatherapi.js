...
let apiURLstring='https://api.openweathermap.org/data/2.5/weather?id=3893894&units=imperial&APPID=e4ca57df03907d58adc6aee8db5d3eb3';
...
let apiURLstringSS='https://api.openweathermap.org/data/2.5/weather?id=5779068&units=imperial&APPID=e4ca57df03907d58adc6aee8db5d3eb3';
...
let weatherRequestCA = new XMLHttpRequest();
let apiURLstringCA='https://api.openweathermap.org/data/2.5/weather?id=5391811&units=imperial&APPID=e4ca57df03907d58adc6aee8db5d3eb3';
weatherRequestCA.open('Get', apiURLstringCA, true);
weatherRequestCA.send();

weatherRequestCA.onload =  function () {
    let weatherDataCA = JSON.parse(weatherRequestCA.responseText);
    console.log (weatherDataCA);

    document.getElementById('high-tempCA').innerHTML=weatherDataCA.main.temp;
    document.getElementById('current-humidityCA').innerHTML=weatherDataCA.main.humidity;
